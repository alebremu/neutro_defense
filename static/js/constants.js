...
// Chemotaxis movement (shared across all levels)
const ROAM_SPEED      = 0.5;  // wander speed when no bacteria nearby
const ATTRACT_SPEED   = 0.9;  // speed when chasing a bacterium
const ATTRACT_RADIUS  = 140;  // sensing radius for nearest bacterium
const WANDER_CHANGE   = 0.04; // per-tick chance to pick a new wander direction
const WALL_BUFFER     = 16;   // keep neutrophils away from vessel walls
